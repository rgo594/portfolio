...
function App() {
  ...
  const cardClickHandler = () => {
    return window.location.replace("https://github.com/rgo594/Contester");
  }
    ...
    <div className="App">
      ...
      <div style={{height:"800px"}}>
        <div class="name">
          ...
          <button class="button" onClick={scrollFunction} id="myBtn" title="Go to Bottom">&nbsp;<Icon onClick={scrollFunction} name='angle down' /></button>
        </div>
      </div>
      <div>
